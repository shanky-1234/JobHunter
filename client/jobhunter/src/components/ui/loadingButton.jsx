...
function LoadingButton({content,className},props) {
  return (
    <button {...props} className={`h-10 bg-blue-200 flex-wrap flex rounded-md ${className}`} disabled>
        <div className='flex justify-center items-center gap-2 w-full text-gray-800'>
             <span>
              <svg
